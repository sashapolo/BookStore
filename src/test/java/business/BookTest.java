...
public class BookTest {
	...
	public void testBookGetPrice1() {
		Book tester = new Book("", "", new Publisher(0, "", ""), 
				new GregorianCalendar(), new Isbn13("9783161484100"), 
				new BigDecimal(120.44), 0);
	...
	public void testBookGetPrice3() {
		Book tester = new Book("", "", new Publisher(0, "", ""), 
				new GregorianCalendar(), new Isbn13("9783161484100"), 
				new BigDecimal(120.44), 48);
		assertEquals(BigDecimal.valueOf(120.44).multiply(BigDecimal.valueOf(0.52)).setScale(2, BigDecimal.ROUND_HALF_UP), 
				tester.getDisplayedPrice());
	}
